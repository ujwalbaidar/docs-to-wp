...
maps.page = createFieldMaps({
	title: /* string */ "title",
	content: /* string */ "description",
	author: /* int */ "wp_author_display_name",
	customFields: /* array */ "custom_fields",
	date: /* datetime */ "dateCreated",
	excerpt: /* string */ "mt_excerpt",
	parent: /* int */ "wp_page_parent_id",
	password: /* string */ "post_password",
	...
	date_modified_gmt: /* datetime */ function( date ) {
		return {
			modified: new Date( date )
		};
	}
